...
_CAPI RK_S32 RK_MPI_SYS_UnBind(const MPP_CHN_S *pstSrcChn, const MPP_CHN_S *pstDestChn);
_CAPI RK_S32 RK_MPI_SYS_RegisterOutCb(const MPP_CHN_S *pstChn, OutCbFunc cb);
_CAPI RK_S32 RK_MPI_SYS_RegisterOutCbEx(const MPP_CHN_S *pstChn, OutCbFuncEx cb, RK_VOID *pHandle);
_CAPI RK_S32 RK_MPI_SYS_RegisterEventCb(const MPP_CHN_S *pstChn, RK_VOID *pHandle, EventCbFunc cb);
_CAPI RK_S32 RK_MPI_SYS_SendMediaBuffer(MOD_ID_E enModID, RK_S32 s32ChnID, MEDIA_BUFFER buffer);
_CAPI RK_S32 RK_MPI_SYS_DevSendMediaBuffer(MOD_ID_E enModID, RK_S32 s32DevId, RK_S32 s32ChnID, MEDIA_BUFFER buffer);
_CAPI RK_S32 RK_MPI_SYS_SetMediaBufferDepth(MOD_ID_E enModID, RK_S32 s32ChnID, RK_S32 u32Depth);
...
_CAPI MEDIA_BUFFER RK_MPI_SYS_GetMediaBuffer(MOD_ID_E enModID, RK_S32 s32ChnID, RK_S32 s32MilliSec);
...
_CAPI RK_S32 RK_MPI_VENC_CreateJpegLightChn(VENC_CHN VencChn, VENC_CHN_ATTR_S *stVencChnAttr);
_CAPI RK_S32 RK_MPI_VENC_GetVencChnAttr(VENC_CHN VencChn, VENC_CHN_ATTR_S *stVencChnAttr);
_CAPI RK_S32 RK_MPI_VENC_SetVencChnAttr(VENC_CHN VencChn, VENC_CHN_ATTR_S *stVencChnAttr);
_CAPI RK_S32 RK_MPI_VENC_GetChnParam(VENC_CHN VencChn, VENC_CHN_PARAM_S *stVencChnParam);
_CAPI RK_S32 RK_MPI_VENC_SetChnParam(VENC_CHN VencChn, VENC_CHN_PARAM_S *stVencChnParam);
_CAPI RK_S32 RK_MPI_VENC_GetRcParam(VENC_CHN VencChn, VENC_RC_PARAM_S *pstRcParam);
_CAPI RK_S32 RK_MPI_VENC_SetRcParam(VENC_CHN VencChn, const VENC_RC_PARAM_S *pstRcParam);
_CAPI RK_S32 RK_MPI_VENC_SetJpegParam(VENC_CHN VencChn, const VENC_JPEG_PARAM_S *pstJpegParam);

_CAPI RK_S32 RK_MPI_VENC_SetRcMode(VENC_CHN VencChn, VENC_RC_MODE_E RcMode);
_CAPI RK_S32 RK_MPI_VENC_SetRcQuality(VENC_CHN VencChn, VENC_RC_QUALITY_E RcQuality);
_CAPI RK_S32 RK_MPI_VENC_SetBitrate(VENC_CHN VencChn, RK_U32 u32BitRate, RK_U32 u32MinBitRate, RK_U32 u32MaxBitRate);
_CAPI RK_S32 RK_MPI_VENC_RequestIDR(VENC_CHN VencChn, RK_BOOL bInstant);
_CAPI RK_S32 RK_MPI_VENC_SetFps(VENC_CHN VencChn, RK_U8 u8OutNum, RK_U8 u8OutDen, RK_U8 u8InNum, RK_U8 u8InDen);
_CAPI RK_S32 RK_MPI_VENC_SetGop(VENC_CHN VencChn, RK_U32 u32Gop);
_CAPI RK_S32 RK_MPI_VENC_SetAvcProfile(VENC_CHN VencChn, RK_U32 u32Profile, RK_U32 u32Level);
_CAPI RK_S32 RK_MPI_VENC_InsertUserData(VENC_CHN VencChn, RK_U8 *pu8Data, RK_U32 u32Len);
_CAPI RK_S32 RK_MPI_VENC_SetResolution(VENC_CHN VencChn, VENC_RESOLUTION_PARAM_S stResolutionParam);

_CAPI RK_S32 RK_MPI_VENC_SetRotation(VENC_CHN VeChn, VENC_ROTATION_E rotation_rate);

_CAPI RK_S32 RK_MPI_VENC_GetRoiAttr(VENC_CHN VencChn, VENC_ROI_ATTR_S *pstRoiAttr, RK_S32 roi_index);
_CAPI RK_S32 RK_MPI_VENC_SetRoiAttr(VENC_CHN VencChn, const VENC_ROI_ATTR_S *pstRoiAttr, RK_S32 region_cnt);

_CAPI RK_S32 RK_MPI_VENC_SetGopMode(VENC_CHN VencChn, VENC_GOP_ATTR_S *pstGopModeAttr);

_CAPI RK_S32 RK_MPI_VENC_RGN_Init(VENC_CHN VencChn, VENC_COLOR_TBL_S *stColorTbl);

_CAPI RK_S32 RK_MPI_VENC_RGN_SetBitMap(VENC_CHN VencChn, const OSD_REGION_INFO_S *pstRgnInfo, const BITMAP_S *pstBitmap);
...
_CAPI RK_S32 RK_MPI_VENC_StartRecvFrame(VENC_CHN VencChn, const VENC_RECV_PIC_PARAM_S *pstRecvParam);
_CAPI RK_S32 RK_MPI_VENC_DestroyChn(VENC_CHN VencChn);
_CAPI RK_S32 RK_MPI_VENC_GetFd(VENC_CHN VencChn);
_CAPI RK_S32 RK_MPI_VENC_QueryStatus(VENC_CHN VencChn, VENC_CHN_STATUS_S *pstStatus);

_CAPI RK_S32 RK_MPI_VENC_SetSuperFrameStrategy(VENC_CHN VeChn, const VENC_SUPERFRAME_CFG_S *pstSuperFrmParam);
_CAPI RK_S32 RK_MPI_VENC_GetSuperFrameStrategy(VENC_CHN VeChn, VENC_SUPERFRAME_CFG_S *pstSuperFrmParam);
